...
public class BroadcastNotifier {
    ...
    public void broadcastUrl(int status,String url,String tag) {
        ...
        // Puts log data into the Intent
        localIntent.putExtra(Constants.EXTENDED_FEED_URL, url);
        localIntent.putExtra(Constants.EXTENDED_FEED_TAG, tag);
        localIntent.addCategory(Intent.CATEGORY_DEFAULT);
